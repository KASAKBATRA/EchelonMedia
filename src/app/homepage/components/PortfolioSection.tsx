...
const PROJECTS: Project[] = [
{
  ...
  year: '2025',
  client: 'Luminary Co.',
  description: 'Full brand identity system, launch campaign across Meta & Google, and 3x ROI in 60 days.',
...
},
{
  ...
  year: '2025',
  client: 'Vibe Studio',
  description: 'Custom Next.js website with 98 Lighthouse score, integrated booking system, and 40% conversion uplift.',
...
export default function PortfolioSection() {
  ...
  return (
    <>
      <section
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 reveal-hidden">
            <div>
              <div className="section-label" style={{ color: '#C8A96E' }}>Portfolio</div>
              <h2
                className="font-display text-echelon-black"
                style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: 700, lineHeight: 1.05, letterSpacing: '-0.03em' }}>
                
                Work that<br />
                <span style={{ fontFamily: 'var(--font-cursive)', fontStyle: 'normal', color: '#C8A96E', fontSize: '1.1em', letterSpacing: '0.01em' }}>speaks.</span>
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div
              ...
              aria-label={`View ${project.title} project details`}>
                ...
                style={{ background: 'linear-gradient(to top, rgba(17,17,17,0.9) 0%, rgba(17,17,17,0.2) 50%, transparent 100%)' }} />
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 z-10">
                  ...
                  style={{ fontSize: 'clamp(1.3rem, 2.5vw, 2rem)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
      ...
      <div ref={backdropRef} className="service-modal-backdrop" onClick={() => setActiveProject(null)} />
        ...
        <>
            ...
            <div style={{ background: '#F5F0E8', minHeight: '100vh' }}>
              ...
              <div className="relative h-[60vh] overflow-hidden">
                ...
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, transparent 40%, rgba(245,240,232,1) 100%)' }} />
              </div>
              {/* Content */}
              <div className="max-w-4xl mx-auto px-6 md:px-10 pb-20 -mt-20 relative z-10">
                ...
                <span
                  ...
                  style={{ background: 'rgba(200,169,110,0.1)', borderColor: 'rgba(200,169,110,0.3)', color: '#C8A96E', fontFamily: 'DM Sans, sans-serif', fontWeight: 600 }}>
                ...
                style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1 }}>
                
                  {activeProject.title}
                </h2>
                <p className="text-echelon-muted text-lg leading-relaxed mb-8 max-w-xl" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div>
                    <div className="text-xs font-bold text-echelon-muted mb-1 uppercase tracking-widest" style={{ fontFamily: 'DM Sans, sans-serif' }}>Client</div>
                    <div className="font-semibold text-echelon-black" style={{ fontFamily: 'DM Sans, sans-serif' }}>{activeProject.client}</div>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-echelon-muted mb-1 uppercase tracking-widest" style={{ fontFamily: 'DM Sans, sans-serif' }}>Category</div>
                    <div className="font-semibold text-echelon-black" style={{ fontFamily: 'DM Sans, sans-serif' }}>{activeProject.category}</div>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-echelon-muted mb-1 uppercase tracking-widest" style={{ fontFamily: 'DM Sans, sans-serif' }}>Year</div>
                    <div className="font-semibold text-echelon-black" style={{ fontFamily: 'DM Sans, sans-serif' }}>{activeProject.year}</div>
                  </div>
                </div>
                ...
                {activeProject.gallery && activeProject.gallery.length > 0 && (
                  <div className="mt-12">
                    <h3
                      className="font-display text-echelon-black mb-4"
                      style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 700, letterSpacing: '-0.02em' }}
                    >
                      Wedding Highlights
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      {activeProject.gallery.map((imgSrc, index) => (
                        <div key={imgSrc} className="relative overflow-hidden rounded-2xl" style={{ aspectRatio: '4 / 5' }}>
                          <AppImage
                            src={imgSrc}
