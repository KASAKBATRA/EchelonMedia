...
// FOREGROUND - sharp, prominent
{
  ...
  layer: 'foreground', x: 3, y: 12, rotation: -5, scale: 1,
  animClass: 'cs-drift-a',
  label: '@echelonmedia', sublabel: '❤️ 4.2k  💬 318'
},
{
  id: 2, type: 'reel',
  ...
  layer: 'foreground', x: 78, y: 8, rotation: 4, scale: 1,
  animClass: 'cs-drift-b',
  label: 'Reel · 2.1M views', sublabel: '▶ Play'
},
{
  id: 3, type: 'branding',
  ...
  layer: 'foreground', x: 6, y: 58, rotation: 3, scale: 1,
  animClass: 'cs-drift-c',
  label: 'Brand Launch', sublabel: 'Campaign live ✓'
},
{
  id: 4, type: 'mockup',
  ...
  layer: 'foreground', x: 74, y: 55, rotation: -4, scale: 1,
  animClass: 'cs-drift-d',
  label: 'Web Design', sublabel: 'Live & converting'
},
// MID LAYER
{
  id: 5, type: 'social',
  ...
  layer: 'mid', x: 28, y: 5, rotation: 6, scale: 0.88,
...
},
{
  ...
  layer: 'mid', x: 58, y: 3, rotation: -7, scale: 0.85,
...
},
{
  ...
  layer: 'mid', x: 20, y: 68, rotation: -3, scale: 0.9,
...
},
{
  ...
  layer: 'mid', x: 64, y: 70, rotation: 5, scale: 0.87,
...
},
{
  ...
  layer: 'mid', x: 43, y: 72, rotation: -2, scale: 0.82,
  animClass: 'cs-drift-a',
...
// BACKGROUND - blurred, large
{
  ...
  layer: 'background', x: -4, y: 30, rotation: 8, scale: 1.3,
  animClass: 'cs-drift-b'
},
{
  id: 11, type: 'branding',
  ...
  layer: 'background', x: 82, y: 28, rotation: -9, scale: 1.25,
  animClass: 'cs-drift-c'
},
{
  id: 12, type: 'reel',
  ...
  layer: 'background', x: 38, y: -5, rotation: 3, scale: 1.4,
  animClass: 'cs-drift-d'
},
{
  id: 13, type: 'mockup',
  ...
  layer: 'background', x: 15, y: 82, rotation: -6, scale: 1.2,
  animClass: 'cs-drift-e'
},
{
  id: 14, type: 'social',
  ...
  layer: 'background', x: 60, y: 85, rotation: 7, scale: 1.35,
  animClass: 'cs-drift-f'
}];
  ...
  return (
    <section
            ...
            <div
              ...
              <div
                ...
                <div
                  ...
                  style={{ background: 'linear-gradient(160deg, rgba(200,169,110,0.12) 0%, rgba(245,240,232,0.08) 100%)', mixBlendMode: 'multiply' }} />
                ...
                <div
                  ...
                  style={{
                    ...
                    {frame.type === 'social' ? '📱 Social' :
                  frame.type === 'reel' ? '🎬 Reel' :
                  frame.type === 'branding' ? '✦ Brand' :
                  frame.type === 'analytics' ? '📊 Data' : '🖥 Web'}
                  </div>
                }
              </div>
              ...
              <div
                ...
                style={{
                  ...
                  <div className="text-xs font-semibold text-echelon-black" style={{ fontFamily: 'DM Sans, sans-serif' }}>{frame.label}</div>
                  {frame.sublabel &&
                <div className="text-xs text-echelon-muted" style={{ fontFamily: 'DM Sans, sans-serif' }}>{frame.sublabel}</div>
                }
                </div>
              }
            </div>);
      ...
      <div
        ...
        style={{
          zIndex: 7,
          background: 'linear-gradient(160deg, rgba(245,240,232,0.72) 0%, rgba(237,232,223,0.65) 50%, rgba(240,235,224,0.72) 100%)'
        }} />
      ...
      <div
        ...
        style={{
          zIndex: 8,
          background: 'radial-gradient(ellipse 55% 60% at 50% 50%, rgba(245,240,232,0.88) 0%, rgba(245,240,232,0.55) 55%, transparent 100%)'
        }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 pt-32 pb-20" style={{ zIndex: 10 }}>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50">
          <div
            ...
            <div className="w-1 h-2 rounded-full bg-echelon-black" style={{ animation: 'floatA 1.5s ease-in-out infinite' }} />
          </div>
          <span className="text-xs font-medium text-echelon-muted" style={{ letterSpacing: '0.15em', fontFamily: 'DM Sans, sans-serif' }}>SCROLL</span>
        </div>
      </div>

      {/* ── TICKER ── */}
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden border-t border-echelon-black/5 bg-echelon-black/4 py-3" style={{ zIndex: 10 }}>
        <div className="ticker-inner">
          {[...Array(2)].map((_, di) =>
          <div key={di} className="flex items-center gap-12 px-8 flex-shrink-0">
              {['Social Media Marketing', 'Event Coverage', 'Branding & Ads', 'Website Development', 'Wedding Diaries', 'Content Creation', 'Digital Strategy'].map((item, i) =>
            <span key={i} className="flex items-center gap-3 whitespace-nowrap text-sm font-medium text-echelon-muted" style={{ fontFamily: 'DM Sans, sans-serif' }}>
