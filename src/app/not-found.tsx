	...
	return (
		<main className="min-h-screen flex items-center justify-center px-6" style={{ background: 'var(--bg-primary)' }}>
			<section className="max-w-xl text-center">
				<p className="text-sm uppercase tracking-[0.2em] mb-4" style={{ color: 'var(--color-muted)' }}>
					404
				</p>
				<h1 className="font-display text-5xl md:text-6xl mb-4" style={{ color: 'var(--color-primary)' }}>
					Page not found
				</h1>
